...
export function Header() {
  return (
    <header className="fixed top-0 left-80 right-0 px-8 py-3 border-b border-white/10 backdrop-blur flex items-center justify-between">
      <button className='w-full max-w-md flex items-center gap-3 text-xs text-zinc-400 bg-white/5 border-white/10 px-3 h-8 rounded-full'>
        <Search size={14} />
      ...
      <div className='flex items-center'>
        <nav className='text-sm flex items-center gap-6'>
          ...
          <a className='text-zinc-400 hover:text-zinc-100 transition-colors' href="">Documentaion</a>
          <a className='text-zinc-400 hover:text-zinc-100 transition-colors' href="">Suppot</a>
        </nav>

        <div className='flex items-center border-l border-whit pl-6 ml-6 gap-6'>
          <button>
